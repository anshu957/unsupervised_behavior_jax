#!/bin/bash
#SBATCH --job-name=grooming10k_motif_videos
...
#SBATCH --output="$LOG_DIR/grooming10k_motif_videos_%A_%a.out"
#SBATCH --error="$LOG_DIR/grooming10k_motif_videos_%A_%a.err"
